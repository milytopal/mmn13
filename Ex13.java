...
public class Ex13 {
    ...
    {
        if((str.length()>0) && (str.charAt(0)>='A' && str.charAt(0)<='Z') || (str.charAt(0)>='a' && str.charAt(0)<='z')) {
            //str = str.toLowerCase();
          ...
          //  if(((str.charAt(0)>='A' && str.charAt(0)<='Z') || (str.charAt(0)>='a' && str.charAt(0)<='z')))
            {
                ...
                //else
                  //  tempNumOfLetters = 1;
                if (str.length() > 1) // string can be shortened only if length is at least 2 characters
